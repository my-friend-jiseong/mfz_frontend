...
export const opacity = {
  ...
  disabledField: 0.7,
  // `hover: 0.92` 는 제거했다 (2026-07-30 §14 감사, callsite 0). Play 전용 앱이라 hover 가
  // 실제로 필요한 자리가 없었고, hover 도입 여부는 14절에 '미결' 로 남아 있다 —
  // 결정 전에 토큰만 있으면 "이미 정해졌다" 로 읽힌다. 정하는 날 이유와 함께 되살린다.
} as const;
