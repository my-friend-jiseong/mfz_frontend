...
>
> **⚠️ 정정 (2026-04-27)**: 본 서비스에는 **관리자(admin) Actor 가 존재하지 않습니다**. 본 historical 문서의 "관리자(403)", "관리자만", "admin role" 등 모든 admin 관련 표현은 무시해 주세요. 그에 따라 §5 (`/api/map/fields` 권한 확장 요청), §7.5 (관리자 토큰 발급 절차) 도 철회되었습니다.
